...
function analyze(d, macro) {
  ...
  const rec=num(d.recommendation_mean), target=num(d.target_mean_price), institutions=num(d.held_percent_institutions), insiders=num(d.held_percent_insiders), shortFloat=num(d.short_percent_float), upside=!target||!price?null:(target-price)/price;
